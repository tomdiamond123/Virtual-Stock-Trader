"""
Django settings for virtualbroker project.
...
SECRET_KEY = 'django-insecure-*0qb)w&jk7wg^2lj#ro*a6@f10c51w#1fz3x@ph%3gn@(2qc1l'
...
WSGI_APPLICATION = 'virtualbroker.wsgi.application'
